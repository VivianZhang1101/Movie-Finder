...
public class TestMovieAndMovieDataReader {
	...
	public boolean testReaderMovieDescriptions() {
		...
		boolean equalOne = true;
		// check if first movie is has of the above descriptions
		...
		// check if second movie is has of the above descriptions
		...
		// check if third movie is has of the above descriptions
	...
	/**
	 * This test reads in 3 movies and tests whether the list of movies
	 * contains all 3 years of the source data in any order. It fails
	...
	public boolean testReaderMovieYears() {
		...
		// check if second movie is has of the above years
		...
		// check if third movie is has of the above years
